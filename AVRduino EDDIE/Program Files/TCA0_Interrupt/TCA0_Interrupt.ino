...
void toggle(){
  ...
  /* By counting to 511, the LED is on for about 1/2 second */
  /* and off for about 1/2 second */
  if((count & 0x01FF) == 0){
  /* Toggle the putput pin */
  LED_TGL;
  }
}
...
int main() {
  ...
  */
  ...
  /* Set clock divider to 256 and count of 152 */
  /* (40 mHz / 256) / 152 = .97 mS             */
  tca0::begin(256, 152);
  tca0::attach_interrupt(toggle);
