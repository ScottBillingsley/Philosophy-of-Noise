/*
      ...
      Example of PWM tone generation for the AVRduino EDDIE..
...
int main() {
  ...
  */
  ...
  tone0.pwm_set_compare(tone0.pwm_calculate_count(261.63, SAMPLE_RATE));
  ...
  while (1) {
    ...
    /* Counter controls the speed of the PWM */
    if (counter >= 500) {
