/*
               AVRduino RTC Interrupt
              Vernon Billingsley  c2025
              AVRduino AVR128DB48

      Setup the real time counter on the AVR128DB48.
...
int main() {
  ...
  */
  ...
  Serial.begin(115200);
   ...
   /* Use 32k internal clock divided by 1024 */
   rtc::begin(RTC_divide_by_1024, OSC32K);
   /* Divide by 15 gives 2 Hz */
   rtc::period(15);
   rtc::interrupt(ENABLE);
   rtc::attach_interrupt(toggle);
