...
/* Declare an instance of the Real Time Clock */
DS3232 rtc(0x68);
...
int main() {
  ...
  */
  ...
  /* Routines to set the DS3232 */
  /* rtc.write(function, data)  */
  /*
    rtc.write(SET_12, 0x00);
    delay(10);
    rtc.write(HOUR, 8);
    delay(10);
    rtc.write(MINUTE,52);
  ...
  */
  ...
  while (1) {
    ...
    if (rtc.seconds() == 0x00) {
      Serial.println(rtc.temperature(), 2);
    }
